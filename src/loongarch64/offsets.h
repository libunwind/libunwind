...
# define LINUX_UC_MCONTEXT_OFF		0x40	/* offsetof(struct ucontext_t, uc_mcontext) */
# define LINUX_UC_SIGMASK_OFF		0x1580	/* offsetof(struct ucontext_t, uc_sigmask) */

# define LINUX_UC_MCONTEXT_PC		0x40	/* offsetof(struct ucontext_t, uc_mcontext.__pc) */
# define LINUX_UC_MCONTEXT_GREGS	0x48	/* offsetof(struct ucontext_t, uc_mcontext.__gregs) */
